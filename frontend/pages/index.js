    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.about}>
          We have built a collection of DeFi Smart-Contracts for CoinEx Smart Chain Ecosystem
        </p>
        ...
        <button className={styles.button}>
          <a
            ...
            href="https://github.com/Mystical94/defi_csc/blob/master/contracts/LendingPool.sol"
        ...
        <button className={styles.button}>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://github.com/Mystical94/defi_csc/blob/master/contracts/Staking.sol"
            className={styles.navlink}
          >
            View on GitHub ↗
          </a>
        ...
        <button className={styles.button}>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://github.com/Mystical94/defi_csc/blob/master/contracts/Vault.sol"
            className={styles.navlink}
          >
            View on GitHub ↗
          </a>
